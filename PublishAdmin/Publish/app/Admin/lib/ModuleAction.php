...
class ModuleAction extends LtAction {
	...
	public function beforeExecute() {
        ...
        $this->data['moduleType'] = array('war','jar', 'php', 'c','tgz');
        $this->data['dockerFlag'] = array('docker','k8s', '非docker');
        $this->data['lbFlag'] = array('nginx','slb','无');
        $this->data['gitEnabled'] = array('True','False');
	}
